...
2007-02-02. That is why I created a subset to work with for making required
plots.
...
I forked and clone the following GitHub repository:
...
After finishing with the assignment, I pushed my git repository to
GitHub so that the GitHub version of my repository is up to
date. There is four PNG files and four R code files.
...
Please check all attached PNG files and you will find that they are construsted 
in accordance with examples shown above.
